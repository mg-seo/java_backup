...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println(cc.add(5));
		System.out.println(cp.add(3));
		System.out.println(cp.add(3));
		
		System.out.println(cc.circle(5));
		System.out.println(cp.circle(5));
		
		System.out.println(cp.rect(5));
		System.out.println(cp.rect(5, 8));
		System.out.println(cp.rect(5, 8, 7));
	}
}
